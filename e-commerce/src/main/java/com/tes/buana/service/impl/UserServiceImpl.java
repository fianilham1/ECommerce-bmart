...
public class UserServiceImpl implements UserService {
    ...
    public Users create(Users users){
        ...
        if(!emailTrue || !passwordTrue) throw new Exception(CommonMessage.AUTH_INVALID_FORMAT);
    ...
    public Users update(Users users){
        ...
        if(!passwordTrue) throw new Exception(CommonMessage.AUTH_INVALID_FORMAT);
    ...
    public Users getUser(Users users) {
        return usersRepository.findByUsernameAndMarkForDeleteIsFalse(users.getUsername()).orElseThrow(() -> new Exception(CommonMessage.USERNAME_NOT_FOUND));
    }
    ...
    public Users getUser(String username) {
        return usersRepository.findByUsernameAndMarkForDeleteIsFalse(username).orElseThrow(() -> new Exception(CommonMessage.USERNAME_NOT_FOUND));
    }
