...
public class ProductCategoryController extends BaseController{
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public Response<String> deleteProductCategory(@PathVariable("id") String productCategoryId) {
        try {
            productCategoryService.deleteProductCategory(productCategoryId);
            return ResponseHelper.ok("delete product category with id "+productCategoryId+" is success");
        } catch (Throwable e) {
